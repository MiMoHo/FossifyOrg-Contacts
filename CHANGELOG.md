...
## [Unreleased]
### Fixed
- Fixed contact photos being omitted when exporting contacts stored in the app's hidden (local) storage to a .vcf file ([#209])
...
[#209]: https://github.com/FossifyOrg/Contacts/issues/209
