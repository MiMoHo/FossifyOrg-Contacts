...
## [Unreleased]
### Fixed
- Fixed custom phone, email, and address labels being converted to lowercase when importing contacts from vCard files ([#208])
...
[#208]: https://github.com/FossifyOrg/Contacts/issues/208
