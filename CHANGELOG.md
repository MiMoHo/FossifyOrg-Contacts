...
## [Unreleased]
### Fixed
- Fixed vCard export failing with an empty file when a contact has a custom label containing a double-quote character ([#198])
...
[#198]: https://github.com/FossifyOrg/Contacts/issues/198
