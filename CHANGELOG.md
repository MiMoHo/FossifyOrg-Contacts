...
## [Unreleased]
### Fixed
- Fixed the IM (Jabber/XMPP) field not being added when saving a contact via an INSERT_OR_EDIT intent ([#467])
...
[#467]: https://github.com/FossifyOrg/Contacts/issues/467
