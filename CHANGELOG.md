...
## [Unreleased]
### Fixed
- Fixed phone numbers displaying with their digit groups in reversed order on right-to-left system languages (e.g. Arabic) ([#207])
...
[#207]: https://github.com/FossifyOrg/Contacts/issues/207
